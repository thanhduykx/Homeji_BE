...
namespace Homeji.Infrastructure.Migrations
{
    ...
    [Migration("20260722000710_AddRoomTransferConsentAudit")]
    partial class AddRoomTransferConsentAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homeji.Domain.Entities.PostMessageAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("post_message_attachments", "homeji");
                });
            ...
            modelBuilder.Entity("Homeji.Domain.Entities.WalletWithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("wallet_withdrawal_requests", "homeji", t =>
                        {
                            t.HasCheckConstraint("ck_wallet_withdrawal_requests_amount", "\"Amount\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Homeji.Domain.Entities.PostMessageAttachment", b =>
                {
                    b.HasOne("Homeji.Domain.Entities.PostMessage", null)
