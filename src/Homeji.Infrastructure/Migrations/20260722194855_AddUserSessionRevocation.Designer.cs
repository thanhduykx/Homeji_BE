...
namespace Homeji.Infrastructure.Migrations
{
    ...
    [Migration("20260722194855_AddUserSessionRevocation")]
    partial class AddUserSessionRevocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Homeji.Domain.Entities.MarketplaceOrder", b =>
                {
                    ...
                    b.HasIndex("Status", "DeliveredAt", "FundsReleasedAt");
            ...
            modelBuilder.Entity("Homeji.Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SessionsRevokedBefore")
                        .HasColumnType("timestamp with time zone")
